...
const Probuctpage = () => {
  return (
    <div className="">
      <AppLayout>
        <Link to="/">
        <button class="bg-[#BA9E88] hover:bg-[#D2C3B9] text-white font-bold py-2 px-4 rounded mt-5 mx-2">
          Back
        </button>
        </Link>
        <div class="grid sm:grid-cols-2 gap-4 grid-cols-1 bg-[#ECECEC] my-10">
          ...
          <div className="  mx-2 lg:mx-20">
            ...
            <div className=" w-[100%] sm:w-[80%]  mt-8 sm:mt-20">
              ...
              <button class="bg-[#BA9E88] hover:bg-[#D2C3B9] text-white font-bold py-2 px-4 rounded  w-[100%]">
                Button
              </button>
              </a>
            </div>
